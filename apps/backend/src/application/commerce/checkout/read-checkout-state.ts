...
function mapCheckoutState(status: StripeCheckoutSessionStatus, paymentStatus: StripeCheckoutPaymentStatus): CheckoutState['state'] {
...
export async function readCheckoutState(checkoutGateway: CheckoutGateway, checkoutSessionId: string): Promise<CheckoutState> {
