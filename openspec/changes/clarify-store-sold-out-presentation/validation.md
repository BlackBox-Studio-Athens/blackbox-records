...
- Task 4.2 remains open for the isolated Local publication integration. Its documented smoke stopped before mutation at the first CMS read with 404 because `start-local-cms.mjs` rejects the documented 8799 fixture port and hard-codes 8787; `start-local-publication.mjs` also targets 8787/4321. The main Local stack at 8787/4321 was not used or changed. The content-workspace browser regressions and publication runtime unit checks passed in the validation runs above.
