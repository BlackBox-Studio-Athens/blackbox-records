...
Reservation prerequisite accepted on 2026-09-10: Worker commit `c503e4d9ab7f09cdc719df8cec9e81ee1f8cac14`, UAT version `89aae672-2249-4dd4-8463-241d0311e7d5`. The user approved the old-account Stripe sandbox for this reservation acceptance. See [reservation acceptance](../archive/2026-09-10-add-checkout-stock-reservations/acceptance.md) for creation/binding, paid settlement, expiry release, replay, collected-shipping, and PRD-closed evidence. Outbox task 4.3 subsequently passed on the same accepted implementation with separate user approval for the controlled retry; see [outbox acceptance](acceptance.md). Neither acceptance certifies a later account cutover.
