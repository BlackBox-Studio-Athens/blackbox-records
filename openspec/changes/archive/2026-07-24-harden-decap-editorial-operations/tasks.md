...
- [x] 2.12 Represent disabled mode without constructing a writable Decap backend configuration.
...
- [x] 19.10 Deploy the implementation commit to UAT, run `cms_admin` and `cms_assets`, and record the passing UAT Static Smoke evidence for that exact commit.
