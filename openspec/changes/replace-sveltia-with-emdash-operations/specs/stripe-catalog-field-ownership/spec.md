...
**Reason**: EmDash replaces repository files as editorial authority.

**Migration**: Preserve the one-way Product Projection and validation through CMS product projection updates Stripe Products.
...
**Migration**: Follow "Editorial and provider edits do not form sync loops" in this capability. Preserve its replacement safety and compatibility scenarios before retiring the old path.

### Requirement: Product Projection remains separate from Price Authority

**Reason**: The hosting/CMS ownership transition replaces this legacy contract, including its provider-specific scenarios.

**Migration**: Follow "CMS Product Projection stays separate from Price Authority" in this capability. Preserve its replacement safety and compatibility scenarios before retiring the old path.

### Requirement: Stripe Prices remain payment authority

**Reason**: The hosting/CMS ownership transition replaces this legacy contract, including its provider-specific scenarios.

**Migration**: Follow "Bound Product default is the selling Price Authority" in this capability. Preserve its replacement safety and compatibility scenarios before retiring the old path.

### Requirement: Price Authority edits happen only through Stripe-owned paths

**Reason**: The hosting/CMS ownership transition replaces this legacy contract, including its provider-specific scenarios.

**Migration**: Follow "Staff and Dashboard commands change Stripe Price Authority" in this capability. Preserve its replacement safety and compatibility scenarios before retiring the old path.

### Requirement: Editorial CMS identifies authoritative commerce operations

**Reason**: The hosting/CMS ownership transition replaces this legacy contract, including its provider-specific scenarios.

**Migration**: Follow "Unified workspace routes actions to their authority" in this capability. Preserve its replacement safety and compatibility scenarios before retiring the old path.
