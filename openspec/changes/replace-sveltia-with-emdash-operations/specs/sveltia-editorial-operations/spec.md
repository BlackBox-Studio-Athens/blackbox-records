...
**Reason**: EmDash and the unified staff workspace replace Sveltia and Git-backed editorial writes.

**Migration**: Import and reconcile content/media, prove protected editing and publication, then retire Sveltia configuration, authentication, previews, and writable routes. Preserve supported editorial semantics and accessibility under emdash-editorial-operations.
