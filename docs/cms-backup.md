...
The isolated restore target is `blackbox-cms-recovery-uat-20260915`, D1 ID `9157f31f-05d0-47fd-b206-35638c0fcd17`, with an equally named private R2 bucket. This uses the eighth of ten database slots. Its bounded restore budget is 386 R2 writes, fewer than 800 R2 reads and fewer than 10,000 D1 statements, with about 422 MB additional media storage. The restore completed successfully through WebStorm: the full database and all 386 media objects were restored after checksum verification. Post-restore identity and public-render comparison remain outstanding. Application bindings, commerce data and PRD remain unchanged. Daily scheduling still requires the pending backup credential approval.
