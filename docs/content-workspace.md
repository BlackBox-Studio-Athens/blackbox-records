...
Updates wait for a 750 ms editing pause while the preview and document are visible. Superseded requests are aborted and ignored. Failed updates retain the last successful HTML, labelled outdated. Fit fills the pane; Desktop and Mobile set actual 1280 px and 390 px iframe widths. Expand contains keyboard focus and restores it on close. Scroll survives updates.
