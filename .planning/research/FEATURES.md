...
| Native `/shop/` collection and product detail | Replaces the current external redirect for the first sellable slice | Medium | Existing distro content, Stripe catalog projection |
