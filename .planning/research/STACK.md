...
| Stripe-collected address + manual BOX NOW partner portal fulfillment | Greece-only shipping path           | Meets the approved MVP without overbuilding automation                                            | MEDIUM     |
